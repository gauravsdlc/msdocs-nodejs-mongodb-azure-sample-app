...
const getReceivedReports = async ({page=1, limit=10, startDate, endDate, search ,sort =-1, orgId , status}) => {
    const skip = (page - 1) * limit;
    const filterQuery = { active: true, invoiceGeneratedFor: mongoose.Types.ObjectId(orgId)};
